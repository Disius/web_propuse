...
<template>
    <MainLayout>
        <div class="grid gap-10 bg-gradient-to-b from-red-950 to-blue-950 mt-16 pt-16">
            <div class="ma-10">
                        ...
                        <div class="grid grid-cols-1">
                            ...
                            <div class="ma-5">
                                <div class="flex mx-auto justify-center">
                                    <div class="text-black text-center text-2xl ma-5">Somos un equipo profesional comprometidos con cada uno de nuestros socios comerciales, con la responsabilidad de cubrir todas y cada unas de sus necesidades y requerimientos</div>
                                </div>
                            </div>
                        </div>
                    </div>
