...
class VacantePolicy
{
    ...
    {
        return $user->can('acceso vacante');
    }
    ...
    {
        return $user->can('mostrar vacante');
    }

    public function edit(User $user, Vacante $vacante): bool
    {
        return $user->can('editar vacante');
    }
    ...
    {
        return $user->can('actualizar vacante');
    }
    ...
    {
        return $user->can('borrar vacante');
    }
